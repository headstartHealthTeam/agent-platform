...
| Continue related delivery while an earlier PR awaits review        | [`headstart-stacked-delivery`](../skills/headstart-stacked-delivery/SKILL.md)                   | [Persistent routing](../skills/headstart-stacked-delivery/references/persistent-routing.md), active repository instructions                                                |
