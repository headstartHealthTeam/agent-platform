...
Launch contracts also live in `workflow-contracts`. Operator adapter `0.9.0` retains the change
...
journal/cursor/binding persistence, competing-candidate handling and Stop authority. Version 0.9.0
